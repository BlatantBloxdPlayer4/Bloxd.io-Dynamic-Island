[![Typing SVG](https://readme-typing-svg.herokuapp.com?size=30&color=00F700&center=true&vCenter=true&width=600&lines=Bloxd.io+Dynamic+Island!)](https://git.io/typing-svg)

A dynamic island for Bloxd.io. Has a clickgui (open with Right shift). IDK why I added it tbh LOL. (**NOTE** you can use this with a client, it's just that the menu might look bad with it. To fix that, inject it via DevConsole (F12) so it doen't get messes up)
...
- 🧠 CPU usage monitor  
- 💾 RAM usage monitor  
- 🎛️ Clean ClickGUI (open with **Right Shift**)  
